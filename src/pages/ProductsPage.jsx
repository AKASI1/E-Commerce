...
export default function ProductsPage() {
  ...
  const sortProducts = (sortType) => {
    switch (sortType) {
      case 1:
        setProducts(
          [...popularProducts].sort((a, b) => a.updatedAt - b.updatedAt)
        );
      case 2:
        setProducts([...popularProducts].sort((a, b) => a.price - b.price));
        break;
      case 3:
        setProducts([...popularProducts].sort((a, b) => b.price - a.price));
        break;
      default:
        return;
    }
  ...
  return (
    <main>
      ...
      >
        ...
        <ProductList products={popularProducts} onAddToCart={addToCart} />
      </Container>
    </main>
  );
}
