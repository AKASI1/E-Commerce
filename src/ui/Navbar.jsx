  ...
  return (
    ...
    >
      ...
      <div className="flex items-center ml-2 space-x-4 md:order-2">
        <Link to="/cart" className="relative flex items-center pl-2">
      ...
      >
        ...
        >
          <NavLink to="/products?category=men">منزلي</NavLink>
          <NavLink to="/products?category=women">خروج</NavLink>
            ...
            <li>
              <Link to="/login">
                <Button secondary className="w-full md:w-auto">
                  <LogIn width={20} height={20} className="ml-2" />
                  تسجيل الدخول
                </Button>
              </Link>
            </li>
            <li>
              <Link to="/register">
                <Button className="w-full md:w-auto">
                  <User width={20} height={20} className="ml-2" />
                  إنشاء حساب
                </Button>
              </Link>
            </li>
